        ...
        <div class="col-lg-8">
          <div class="breadcrumb_iner">
            <div class="breadcrumb_iner_item">
              <h2>contact us</h2>
              <p><span style="color:red; font-weight:bold">Home</span> <span>-</span> <span style="color: blue; font-weight:bold">Contact</span></p>
            </div>
          </div>
        </div>
      </div>
  ...
  <section class="contact-section padding_top">
    <div class="container">
      <div class="d-none d-sm-block mb-5 pb-4">
        ...
        <script>
          function initMap() {
            // Set the coordinates for the specific location in Accra
            var location = { lat: 5.6037, lng: -0.1870 };
            ...
            // Initialize the map centered on the specified location
            ...
            var marker = new google.maps.Marker({
              position: location,
              map: map,
              title: "Ministry of Education, Accra"
            });
          }
        </script>
        <script
          src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCtPfLjeWlVMWqeg3z7mnC2ys8y9-sBbIU&callback=initMap">
        </script>

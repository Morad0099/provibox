        ...
        <div class="col-lg-8">
          <div class="breadcrumb_iner">
            <div class="breadcrumb_iner_item">
              <h2>Shop Single</h2>
              <p><span style="color:red; font-weight:bold">Home</span> <span>-</span> <span style="color: blue; font-weight:bold">Shop Single</span></p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row s_product_inner justify-content-between">
        <div class="col-lg-7 col-xl-7">
          <div class="product_slider_img">
            <div id="vertical">
              <div data-thumb="new_img/ImageToStl.com_3 (1).png">
                <img src="new_img/ImageToStl.com_2 (4).png" />
              </div>
              <div data-thumb="new_img/ImageToStl.com_4 (1).png">
                {{-- <img src="img/product/single-product/product_1.png" /> --}}
              </div>
              <div data-thumb="new_img/ImageToStl.com_4.png">
                {{-- <img src="img/product/single-product/product_1.png" /> --}}
              </div>
